...
[`[Paper]`](https://arxiv.org/abs/2311.18531)  [`[Code]`](https://github.com/Liu-Hy/WMDD)  [`[Website]`](https://liu-hy.github.io/WMDD/) [`[Distilled Data]`](https://drive.google.com/drive/folders/1Tm0KZXtPrslgURtF0d2rq_5RRmQOTjmW?usp=drive_link)
...
## Distilled Data
Our distilled datasets and teacher model checkpoints are publicly available on [Google Drive](https://drive.google.com/drive/folders/1Tm0KZXtPrslgURtF0d2rq_5RRmQOTjmW?usp=drive_link). You can directly use them to skip the recovery stage and evaluate with the provided scripts.
